...
pub fn config_callback(
    ...
    match key.as_str() {
        ...
        "table_store.directory" => Ok(Box::new(get_table_store_path(&app_dir))),
        "table_store.delete" => Ok(Box::new(false)),
        "block_store.directory" => Ok(Box::new(get_block_store_path(&app_dir))),
        ...
        "protected_store.directory" => Ok(Box::new(get_protected_store_path(&app_dir))),
        ...
        "network.tls.certificate_path" => Ok(Box::new(get_certfile_path(&app_dir))),
        "network.tls.private_key_path" => Ok(Box::new(get_keyfile_path(&app_dir))),
...
fn get_block_store_path(app_dir: &String) -> String {
    format!("{}/bs", app_dir)
}

fn get_table_store_path(app_dir: &String) -> String {
    format!("{}/ts", app_dir)
}

fn get_protected_store_path(app_dir: &String) -> String {
    format!("{}/ps", app_dir)
}

fn get_certfile_path(app_dir: &String) -> String {
    format!("{}/cert", app_dir)
}

fn get_keyfile_path(app_dir: &String) -> String {
    format!("{}/key", app_dir)
}
