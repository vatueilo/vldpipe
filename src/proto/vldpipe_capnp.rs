...
pub mod connect {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 48] = [
      ...
      ::capnp::word(202, 77, 218, 66, 215, 253, 216, 157),
      ::capnp::word(20, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(70, 140, 132, 232, 115, 74, 191, 211),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(112, 114, 111, 116, 111, 47, 118, 108),
      ::capnp::word(100, 112, 105, 112, 101, 46, 99, 97),
    ...
    pub const TYPE_ID: u64 = 0x9dd8_fdd7_42da_4dca;
  }
}
...
pub mod message {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 49] = [
      ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
      ::capnp::word(220, 130, 130, 219, 92, 38, 227, 139),
      ::capnp::word(20, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(70, 140, 132, 232, 115, 74, 191, 211),
      ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub static NONUNION_MEMBERS : &[u16] = &[0,1];
    pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
    pub const TYPE_ID: u64 = 0x8be3_265c_db82_82dc;
  }
}
